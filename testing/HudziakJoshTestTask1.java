...
/*
 *
 *  Created by Josh Hudziak on 15/02/2021.
 *
 */

public class HudziakJoshTestTask1 {
    ...
    public void normalRateEqualZero() throws Exception  {
        Rate rt = new Rate(CarParkKind.STUDENT, BigDecimal.valueOf(0), BigDecimal.valueOf(0), reducedPeriods, normalPeriods);
    }
